...
def generate_interview_questions(resume_summary, job_description):
    ...
    try:
        # Format the prompt
        prompt = f"Generate interview questions based on the following resume and job description: Resume Summary: {resume_summary} Job Description: {job_description} Questions: in text format"
