...
def generate_interview_questions(resume_summary, job_description):
    ...
    """
    try:
        prompt = f"Generate interview questions based on the following resume and job description: resume : {resume_summary} Job Description: {job_description} Questions: JSON-like structure to represent the sections, subsections, and questions.Strictly stick to this format without any extra data/text in the response."
